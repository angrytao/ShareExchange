...
import st from './ArcGISHeatLayerStyle.less';
import std from '../default.less';

class ArcGISHeatLayerStyle extends Component {
  constructor(ps) {
    super(ps);
    let { config } = ps;
    this.state = {
  ...
  render() {
    ...
    return (
      <div className={st.ArcGISHeatLayerStyle}>
                ...
                <div className={std.valuebar}>
                  <Slider
                    ...
                    onChange={e => {
                      ...
                      $(layer.heat._canvas).css('opacity', e);
                    }}
                  />
                </div>
...
export default ArcGISHeatLayerStyle;
